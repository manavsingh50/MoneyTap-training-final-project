...
public class BillPaymentController {
    ...
    @PostMapping("")
    public void addBillPayment(@RequestParam String billType, @RequestParam double amount, @RequestParam Date date, @RequestParam String walletId){
        try {
            billPaymentService.addBill(billType, amount, date, walletId);
