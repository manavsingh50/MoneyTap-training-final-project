...
public class BeneficiaryDetailsController {
    ...
    @PostMapping("add")
    public void addBeneficiaryDetails(@RequestParam String userWalletId, @RequestParam String beneficiaryWalletId, @RequestHeader(name="Authorization") String token){
...
//        Wallet userWallet = beneficiaryDetailsService.getWalletByUserId(customer, token);
        beneficiaryDetailsService.addBeneficiary(userWalletId, beneficiaryWalletId);
    }
